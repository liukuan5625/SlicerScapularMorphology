...
class ScapulaMorphology(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("ScapulaMorphology")  # TODO: make this more human readable by adding spaces
...
class ScapulaMorphologyWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self) -> None:
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath("UI/ScapulaMorphology.ui"))
        ...
        self.logic = ScapulaMorphologyLogic()
...
class ScapulaMorphologyLogic(ScriptedLoadableModuleLogic):
    ...
    def process(self,
        ...
        scapulaMorphologyExecutablePath = os.path.join(self.path, 'Scripts', "scapularmorphology_inference.py")
        scapulaMorphologyCommand = [pythonSlicerExecutablePath, scapulaMorphologyExecutablePath]
    ...
    def processVolume(self, scaInputFile, humInputFile, scapulaVolume, humerusVolume,
        ...
        logging.info(_('Creating segmentations with ScapulaMorphology AI...'))
        logging.info(_("ScapulaMorphology arguments: {options}").format(options=options))
        proc = slicer.util.launchConsoleProcess(scapulaMorphologyCommand + options)
    ...
    def readSegmentation(self, output2DSegmentationFile):
        segNode2D = slicer.mrmlScene.AddNewNodeByClass("vtkMRMLSegmentationNode", "ScapulaGlenoid")
        scavolumeStorageNode = slicer.mrmlScene.CreateNodeByClass("vtkMRMLSegmentationStorageNode")
...
#
# ScapulaMorphologyTest
#

class ScapulaMorphologyTest(ScriptedLoadableModuleTest):
    def setUp(self):
